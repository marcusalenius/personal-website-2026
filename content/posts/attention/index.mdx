...
lede: "How do large language models work? Together, we develop intuition behind the core idea that makes them possible: attention."
date: 2025-08-10
maxTocLevel: 2
slug: attention
unlisted: false
...
<Figure>
  <Video src="./media/attention-hero.mp4" poster="./media/attention-hero.jpg" />
</Figure>
...
<Figure>
  <Video src="./media/attention-predict.mp4" poster="./media/attention-predict.jpg" />
  <Caption>With each word we associate some <em>information</em> which is used to predict the next word.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-classification.mp4" poster="./media/attention-classification.jpg" />
  <Caption>We perform multiclass classification on the context vector associated with "a".</Caption>
</Figure>
...
Our first idea may be to represent "a" with some fixed vector. We will call this the embedding of "a". Then, we learn the weight matrix so that the row for “time” becomes as similar as possible to the embedding of “a”. There is an issue with this approach though: we only look at the word "a" to determine the next word. So if we were able to train the model to output "time" given the embedding of "a", it would correctly complete the phrase "once upon a time", but it would incorrectly complete a phrase like "the sun is a star" and instead output "the sun is a time". 
...
<Figure>
  <Video src="./media/attention-similar-classification.mp4" poster="./media/attention-similar-classification.jpg" />
  <Caption>Two very similar context vectors lead to the same output.</Caption>
</Figure>
...
<Figure>
  <Image src="./media/attention-random-embedding.png" alt="We can plot our random embeddings in a 2D space." />
  <Caption>We can plot our random embeddings in a 2D space.</Caption>
</Figure>
...
<Figure>
  <Image src="./media/attention-meaningful-embedding.png" alt="A more meaningful embedding where similar words are near each other." />
  <Caption>A more meaningful embedding where similar words are near each other.</Caption>
</Figure>
...
<Figure>
  <Image src="./media/attention-generic-apple-embedding.png" alt='Generic embedding of "apple".' />
  <Caption>Generic embedding of "apple".</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-apple-pulled-side-by-side.mp4" poster="./media/attention-apple-pulled-side-by-side.jpg" />
  <Caption>On the left "apple" is pulled by "banana" and on the right it is pulled by "phone".</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-all-embeddings.mp4" poster="./media/attention-all-embeddings.jpg" />
  <Caption>The other words are not very similar to "apple", so they don't exert as much pulling force.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-all-dot-product.mp4" poster="./media/attention-all-dot-product.jpg" />
  <Caption>We compute the dot product between "apple" and every word as our measure of similarity.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-all-softmax.mp4" poster="./media/attention-all-softmax.jpg" />
  <Caption>We apply softmax to turn the dot products into coefficients for the linear combination.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-update-apple.mp4" poster="./media/attention-update-apple.jpg" />
  <Caption>We compute the updated vector for "apple" using the attention scores.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-table-dot-products.mp4" poster="./media/attention-table-dot-products.jpg" />
  <Caption>For each row, we compute the the dot product with the word in each column.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-table-softmax.mp4" poster="./media/attention-table-softmax.jpg" />
  <Caption>We apply softmax to each row.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-table-weighted-sum.mp4" poster="./media/attention-table-weighted-sum.jpg" />
  <Caption>We compute the weighted average along each row.</Caption>
</Figure>
...
<Figure>
  <Image src="./media/attention-generic-apple-embedding.png" alt="Our original embedding space." />
  <Caption>Our original embedding space.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-apply-transformation.mp4" poster="./media/attention-apply-transformation.jpg" />
  <Caption>Applying a linear transformation to each embedding vector.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-transform-axes.mp4" poster="./media/attention-transform-axes.jpg" />
  <Caption>We transform the axes as well.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-three-transformed-spaces.mp4" poster="./media/attention-three-transformed-spaces.jpg" />
  <Caption>Our original space and two transformed spaces.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-values-lin-comb.mp4" poster="./media/attention-values-lin-comb.jpg" />
  <Caption>We use transformed versions of the vectors, called *values* in the linear combination.</Caption>
</Figure>
...
<Figure>
  <Image src="./media/attention-asymmetric-forces.png" alt="Our desired asymmetric pulling forces." />
  <Caption>Our desired asymmetric pulling forces.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-key-query-transformation-part-one.mp4" poster="./media/attention-key-query-transformation-part-one.jpg" />
  <Caption>When we compute the pulling force — that is the similarity (dot product) — one vector comes from the key space and the other from the query space.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-key-query-transformation-part-two.mp4" poster="./media/attention-key-query-transformation-part-two.jpg" />
  <Caption>Applying different transformations to the key and query spaces results in asymmetric pulling forces.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-key-query-dp.mp4" poster="./media/attention-key-query-dp.jpg" />
  <Caption>We compute the dot product between the query and the keys.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-table-kqv.mp4" poster="./media/attention-table-kqv.jpg" />
  <Caption>Attention using keys, queries, and values applied to the whole phrase.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-semantic-transformation.mp4" poster="./media/attention-semantic-transformation.jpg" />
  <Caption>The *semantic* space gives the most effect of pulling "apple" towards "banana".</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-grammatical-transformation.mp4" poster="./media/attention-grammatical-transformation.jpg" />
  <Caption>The *grammatical relations* space separates a red apple from a green apple, for example.</Caption>
</Figure>
...
<Figure>
  <Video src="./media/attention-multi-head-projection.mp4" poster="./media/attention-multi-head-projection.jpg" />
  <Caption>To combine the outputs of the two heads we concatenate them into one big matrix and use a learned weight matrix to project it down into a matrix of the correct shape. This final matrix contains our updated embedding vectors.</Caption>
</Figure>
