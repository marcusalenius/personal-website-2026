...
The design of this website is inspired by [Gabriel Sha's](https://gsha22.github.io/), [Ben Cuan's](https://bencuan.me/), and [Nikhil Jha's](https://nikhiljha.com/) websites. It is typeset in [Nunito Sans](https://fonts.google.com/specimen/Nunito+Sans) and `code` is in [Inconsolata](https://fonts.google.com/specimen/Inconsolata?preview.script=Latn). The icons are [Phosphor Icons](https://phosphoricons.com/).
